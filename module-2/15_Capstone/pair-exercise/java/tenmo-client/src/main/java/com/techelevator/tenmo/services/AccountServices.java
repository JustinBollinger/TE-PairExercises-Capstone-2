...
public class AccountServices 
{
	...
	public static BigDecimal viewCurrentBalance() 
	{
		...
		Double balance = restTemplate.exchange(API_BASE_URL + "users/" + currentUser.getUser().getId()
				+ "/balance",
			...
			String[] transferStatus, int i, String transferDetails) 
{
	...
	{
	System.out.println("Please register as a new user account.");
	...
	while (!isRegistered)
	{
		...
		try {
			...
			isRegistered = true;
			System.out.println("Registration successful. You can now log into you TEnmo Account!");
